                ...
                <article class="blog-card blog-card-clickable" data-post-id="<?php echo e($post->post_id); ?>">
                    <header class="blog-card-header">
                        ...
                        <div class="blog-card-meta">
                            Por <?php echo e($post->author); ?> • <?php echo e($post->published_at->format('d/m/Y')); ?>
                    ...
                    <div class="blog-full-content" id="content-<?php echo e($post->post_id); ?>" style="display: none;">
                        ...
                        <p class="meta">Por <?php echo e($post->author); ?> • <?php echo e($post->published_at->format('d/m/Y')); ?></p>
...
<?php /**PATH C:\laragon\www\Lanastina\resources\views/blog/index.blade.php ENDPATH**/ ?>